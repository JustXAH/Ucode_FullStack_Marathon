let houseMixin = {
    ...
    wordInsertAfter(str1, str2) {
        ...
        this.description = [this.description.slice(0, len), " ", str2,
            this.description.slice(len)].join('');
    },
    wordDelete(str) {
        let lenBefore = this.description.indexOf(str);
        let lenAfter = this.description.indexOf(str) + str.length;
        this.description = [this.description.slice(0, lenBefore),
            this.description.slice(lenAfter)].join('');
    },
    wordEncrypt() {
